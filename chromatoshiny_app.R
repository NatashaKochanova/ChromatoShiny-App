  ...
  fluidRow(
    column(
      ...
      tabsetPanel(
        tabPanel(
          "Main page", br(),
          tags$div(HTML(paste("This is an app for plotting .txt files, exported from the UNICORN", tags$sup("TM"), " software, used to output intensity values from column chromatography.", sep = ""))), br(), br(),
          "The info about how to plot can be found in respective tabs", br(),
          "The app was published in XXX", br(),
          "Happy plotting!"
        ),
        tabPanel(
          "General",
          fileInput("file1", 'Load .txt file (exported from "Unicorn" software)', accept = c(".txt")),
          ...
          column(
            ...
            infoBox("Info for",
              ...
              subtitle = tags$p("choose the background, choose if you would like to plot 260/280 nm curves and fit a baseline for chromatography 260/280 nm profiles. You can change curve colors, or fill the area under the 260/280 nm curves in tab “Colors”. The plot can be downloaded as a .pdf file (click “Download plot”)."),
